...
var _ = yob.GoUnusedProtection__

func Usage() {
	fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
	flag.PrintDefaults()
	fmt.Fprintln(os.Stderr, "\nFunctions:")
	fmt.Fprintln(os.Stderr, "  GetUserYOBResp GetUserYOB(GetUserYOBReq req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := yob.NewYOBServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "GetUserYOB":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetUserYOB requires 1 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		argvalue0 := yob.NewGetUserYOBReq()
		...
		value0 := argvalue0
		fmt.Print(client.GetUserYOB(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
